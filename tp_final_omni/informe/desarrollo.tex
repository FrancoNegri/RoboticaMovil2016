\subsection{Adaptacion del modelo cinemático}
...
En el siguiente gráfico podemos ver la trayectoria completa comparando los valores obtenidos con la consigna que habiamos definido:
...
%\includegraphics - KalmanEsquema.png
...
%TODO: Hablar sobre la experimentación que pide sobre modificar la covarianza inicial. Sobre esto lo unico que hay para mencionar (abajo) es que se experimento con distintos niveles de covarianza inicial tanto para sensado como para movimiento pero en ambos casos el valor se estabiliza en pocas iteraciones.
...
Finalmente, si el robot no es capaz de sensar ningun poste, la covarianza tanto en $x$ como en $y$ aumenta.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Detalles del sistema desarrollado}  ---> En mi opinion esto queda mejor como apendice o despues de la intro, lo moveria..

%La implementación del sistema completo requiere de la comunicacion de los siguientes nodos:

%\includegraphics[width=\linewidth]{rqtgraphekf.png} 

%TODO breve descripcion de la comunicacion entre nodos:
...
Por su parte el nodo "localizer" se suscribe a los tópicos de odometría, la información de sensado y la ubicación del robot y postes en el simulado, con esto obtiene las consignas de covarianza y publica las transformaciones desde el marco EKF al del robot.

Por último el detector de landmarks de la IMU usa la información usa la informacion de scanning para actualizar la información de distancia respecto a los "landmarks".
