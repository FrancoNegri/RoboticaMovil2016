...
%diagrama EKF en apunte kalman_notes01.pdf
...
%TODO: modificacion de la covarianza inicial. Sobre esto lo unico que hay para mencionar (abajo) es que se experimento con distintos niveles de covarianza inicial tanto para sensado como para movimiento pero en ambos casos el valor se estabiliza en pocas iteraciones.
...
Ahora posicionando el robot para que solo sence un poste, el grado de certeza decae considerablemente. Dado que ahora solo tenemos la referencia al eje $x$ la covarianza en el eje $y$ empieza a aumentar haciendo perceptible el elipsoide violeta ensanchandose sobre ese eje .
...
En este caso podemos ver que el base\_link\_ekf permanece casi pegado al ground\_truth durante todo el recorrido. Adenas contamos con el base\_link (estimación odometrica sin utiliazar ekf) para analizar de manera comparativa con los otros dos valores. En este caso en particular, el base\_link no se aparta demasiado de los otros dos valores.
...
%-lazo cerrado: adaptacion del modelo cinematico y control de feedback
